...
#Simple script for personal financial control 
#Made and tested with python version : 3.8.5
#License: GPL V2
...
def list_reg(listoption = 'all'):
    lregs  = readFile('financeiro.csv') # carrega os registros do arquivo e retorna como uma lista(tambem conhecido como array)
